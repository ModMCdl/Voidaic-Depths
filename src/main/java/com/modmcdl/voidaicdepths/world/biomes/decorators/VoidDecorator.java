...
public class VoidDecorator
{
    ...
    public static final BlockState VOID_CLOUDS = VoidaicBlocks.VOID_CLOUD.get().getDefaultState();
    public static final BlockClusterFeatureConfig VOID_CLOUD_CONFIG = (new BlockClusterFeatureConfig.Builder(new SimpleBlockStateProvider(VOID_CLOUDS), new SimpleBlockPlacer())).tries(4).build();
