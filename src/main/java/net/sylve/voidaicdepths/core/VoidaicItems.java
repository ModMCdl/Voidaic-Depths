...
import net.sylve.voidaicdepths.core.items.VoidMusicDisc;
...
public class VoidaicItems
{
    ...
    public static final Item THE_VOID_MUSIC_DISC = registerItem("the_void_music_disc", new VoidMusicDisc(7, VoidaicSounds.THE_VOID_DISC, new FabricItemSettings().group(VoidaicDepths.VDITEMGROUP).maxCount(1).rarity(Rarity.RARE)));
    public static final Item REMNANTS_MUSIC_DISC = registerItem("remnants_music_disc", new VoidMusicDisc(7, VoidaicSounds.REMNANTS_DISC, new FabricItemSettings().group(VoidaicDepths.VDITEMGROUP).maxCount(1).rarity(Rarity.RARE)));
    public static final Item OSSIFY_MUSIC_DISC = registerItem("ossify_music_disc", new VoidMusicDisc(7, VoidaicSounds.OSSIFY_DISC, new FabricItemSettings().group(VoidaicDepths.VDITEMGROUP).maxCount(1).rarity(Rarity.RARE)));
