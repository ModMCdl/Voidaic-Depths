...
import net.modmcdl.voidaicdepths.core.blocks.VoidCarrotCrop;
import net.modmcdl.voidaicdepths.core.blocks.VoidPlant;
...
public class VoidaicBlocks
{
    ...
    public static final Block FLESHY_VOIDSTONE = registerVoidBlock("fleshy_voidstone", new Block(FabricBlockSettings.copy(VOIDSTONE).sounds(BlockSoundGroup.NETHERRACK)));

    public static final Block OSSIFICUM_ORE = registerVoidBlock("ossificum_ore", new Block(FabricBlockSettings.copy(VOIDSTONE).sounds(BlockSoundGroup.NETHERRACK)));
    ...
    public static final Block VOID_METAL_BLOCK = registerVoidBlock("void_metal_block", new Block(FabricBlockSettings.of(Material.METAL)));
